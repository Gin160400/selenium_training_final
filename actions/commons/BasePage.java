...
public class BasePage {
    ...
    public void clickToElement(WebDriver driver, String location){
        waitElementClickable(driver,location);
        getWebElement(driver, location).click();
    }
    public void sendKeyToElement(WebDriver driver, String location, String keyWord){
        waitElementVisible(driver,location);
        getWebElement(driver,location).clear();
        getWebElement(driver,location).sendKeys(keyWord);
    }
